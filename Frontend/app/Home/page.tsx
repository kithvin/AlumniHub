...
//           <div className="mx-auto flex w-fit items-center gap-3 text-white sm:mx-0">
...
//         <div>
//           <span className="mx-auto flex w-fit items-center gap-2 rounded-full bg-white/20 px-4 py-2 text-sm font-medium sm:mx-0">
//             <Network size={16} className="text-blue-200" />
//             Alumni Management System
//           </span>

//           <h2 className="mt-6 text-center text-3xl font-bold leading-tight sm:text-left sm:text-4xl md:text-6xl">
//             Connect Alumni,
//             <br />
//             Manage Events,
//             <br />
...
//           <p className="mt-6 max-w-xl text-center text-base leading-7 text-blue-100 sm:text-left sm:text-lg sm:leading-8">
...
//                 className="w-full cursor-pointer rounded-xl bg-white px-6 py-3 text-center font-semibold text-indigo-700 shadow-md transition hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-70"
//               >
